...
exports.rule = {
    ...
    create(context) {
        ...
        function isPrimitive(node) {
            const type = (0, utils_1.getTypeFromTreeNode)(node, services);
        ...
        return {
            'BinaryExpression[operator="in"]': (node) => {
                ...
                if (isPrimitive(right)) {
                    ...
                    context.report({
                        message: (0, utils_1.toEncodedMessage)('TypeError can be thrown as this operand might have primitive type.', [opToken]),
                        node: right,
                    });
                }
            },
