...
exports.rule = {
    ...
    create(context) {
        if (!(0, utils_1.isRequiredParserServices)(context.parserServices)) {
            return {};
        }
        function checkProperty(node) {
            ...
            if (typeNode) {
                ...
                const message = (0, utils_1.toEncodedMessage)("Consider removing 'undefined' type or '?' specifier, one of them is redundant.", secondaryLocations);
                context.report({
                    message,
