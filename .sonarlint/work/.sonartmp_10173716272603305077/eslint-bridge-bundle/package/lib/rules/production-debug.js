...
function checkErrorHandlerMiddleware(context, callExpression) {
    ...
    if (callee.type === 'MemberExpression' &&
        (0, utils_1.isIdentifier)(callee.property, 'use') &&
        args.length > 0 &&
        !isInsideConditional(context)) {
        for (const m of (0, utils_1.flattenArgs)(context, args)) {
            const middleware = (0, utils_1.getUniqueWriteUsageOrNode)(context, m);
            if (middleware &&
                middleware.type === 'CallExpression' &&
                ((_a = (0, utils_1.getModuleNameOfNode)(context, middleware.callee)) === null || _a === void 0 ? void 0 : _a.value) === ERRORHANDLER_MODULE) {
                context.report({
                    node: middleware,
                    message,
                });
