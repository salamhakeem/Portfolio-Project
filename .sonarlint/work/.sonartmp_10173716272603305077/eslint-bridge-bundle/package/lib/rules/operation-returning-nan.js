    ...
    create(context) {
        ...
        return {
            'BinaryExpression, AssignmentExpression': (node) => {
                ...
                const leftType = (0, utils_1.getTypeFromTreeNode)(expression.left, services);
                const rightType = (0, utils_1.getTypeFromTreeNode)(expression.right, services);
            ...
            'UnaryExpression, UpdateExpression': (node) => {
                ...
                const argType = (0, utils_1.getTypeFromTreeNode)(expr.argument, services);
