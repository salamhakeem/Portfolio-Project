...
function isArrayMutatingCall(memberExpression, services, propertyText) {
    return arrayMutatingMethods.includes(propertyText) && (0, utils_1.isArray)(memberExpression.object, services);
}
...
function isGetAccessor(node, services) {
    const symbol = (0, utils_1.getSymbolAtLocation)(node, services);
...
function isReturnedExpression(node) {
    const ancestors = (0, utils_1.localAncestorsChain)(node);
