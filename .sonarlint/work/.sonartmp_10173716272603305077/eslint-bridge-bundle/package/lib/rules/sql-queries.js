    ...
    create(context) {
        ...
        return {
            ...
            CallExpression(node) {
                ...
                if ((0, utils_1.isRequireModule)(call, ...dbModules)) {
                    isDbModuleImported = true;
                    return;
                }
                if (isDbModuleImported &&
                    (0, utils_1.isMemberWithProperty)(callee, 'query') &&
...
function isQuestionable(sqlQuery) {
    ...
    return (sqlQuery.type === 'CallExpression' && (0, utils_1.isMemberWithProperty)(sqlQuery.callee, 'concat', 'replace'));
}
