...
const getEncryptionRuleModule = (clientSideMethods, serverSideMethods, message) => ({
    create(context) {
        // for client side
        ...
        return {
            ...
            MemberExpression(node) {
                ...
                if ((0, utils_1.isIdentifier)(property, 'subtle') &&
                    ((0, utils_1.isIdentifier)(object, 'crypto') || (0, utils_1.isMemberWithProperty)(object, 'crypto'))) {
...
function checkForServerSide(callee, context, serverSideMethods, message) {
    ...
    if (callee.type === 'MemberExpression' &&
        (0, utils_1.isMemberWithProperty)(callee, ...serverSideMethods) &&
        callee.object.type === 'Identifier') {
        moduleName = (0, utils_1.getModuleNameOfIdentifier)(context, callee.object);
    }
    else if ((0, utils_1.isIdentifier)(callee, ...serverSideMethods)) {
        moduleName = (0, utils_1.getModuleNameOfImportedIdentifier)(context, callee);
    }
...
function checkForClientSide(callee, context, clientSideMethods, message) {
    if ((0, utils_1.isIdentifier)(callee, ...clientSideMethods) ||
        (0, utils_1.isMemberWithProperty)(callee, ...clientSideMethods)) {
        context.report({
            message,
            node: callee,
        });
...
exports.rule = getEncryptionRuleModule(clientSideEncryptMethods, serverSideEncryptMethods, message);
