...
exports.rule = {
    create(context) {
        function getValueOfProperty(objectExpression, propertyName) {
            const unsafeProperty = (0, utils_1.getObjectExpressionProperty)(objectExpression, propertyName);
            if (unsafeProperty) {
                return (0, utils_1.getValueOfExpression)(context, unsafeProperty.value, 'Literal');
            }
            return undefined;
        }
        ...
        function checkSslOptions(optionsNode) {
            var _a, _b;
            const options = (0, utils_1.getValueOfExpression)(context, optionsNode, 'ObjectExpression');
            ...
            const secureOptions = (0, utils_1.getObjectExpressionProperty)(options, 'secureOptions');
        ...
        function collectIdentifiersFromBinary(node, acc) {
            ...
            if (node.type === 'BinaryExpression') {
                ...
                ((_a = (0, utils_1.getModuleNameOfNode)(context, node.object)) === null || _a === void 0 ? void 0 : _a.value) === 'constants' &&
        ...
        return {
            CallExpression: (node) => {
                ...
                if ((0, utils_1.isCallToFQN)(context, callExpression, 'https', 'request')) {
                ...
                if ((0, utils_1.isCallToFQN)(context, callExpression, 'request', 'get')) {
                    checkSslOptions(callExpression.arguments[0]);
                }
                // https://nodejs.org/api/tls.html#tls_tls_connect_options_callback
                if ((0, utils_1.isCallToFQN)(context, callExpression, 'tls', 'connect')) {
                    checkSslOptions(callExpression.arguments[0]);
                    checkSslOptions(callExpression.arguments[1]);
                    checkSslOptions(callExpression.arguments[2]);
                }
                // https://nodejs.org/api/tls.html#tls_tls_createsecurecontext_options
                if ((0, utils_1.isCallToFQN)(context, callExpression, 'tls', 'createSecureContext')) {
                    checkSslOptions(callExpression.arguments[0]);
                }
            },
        };
