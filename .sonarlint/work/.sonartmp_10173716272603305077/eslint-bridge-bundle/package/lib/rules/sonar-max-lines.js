...
exports.rule = {
    ...
    create(context) {
        ...
        const commentLineNumbers = (0, sonar_max_lines_per_function_1.getCommentLineNumbers)(sourceCode.getAllComments());
        return {
            'Program:exit': (node) => {
                if (!node.loc) {
                    return;
                }
                const lineCount = (0, sonar_max_lines_per_function_1.getLocsNumber)(node.loc, lines, commentLineNumbers);
