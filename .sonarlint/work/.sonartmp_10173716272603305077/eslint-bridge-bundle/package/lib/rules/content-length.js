...
function checkCallExpression(context, callExpression) {
    ...
    const moduleName = (0, utils_1.getModuleNameOfImportedIdentifier)(context, identifierFromModule) ||
        (0, utils_1.getModuleNameOfIdentifier)(context, identifierFromModule);
    if (!moduleName) {
        return;
    }
...
function checkFormidable(context, callExpression) {
    ...
    if (options) {
        const property = (0, utils_1.getObjectExpressionProperty)(options, MAX_FILE_SIZE);
...
function checkMulter(context, callExpression) {
    ...
    const limitsPropertyValue = (_a = (0, utils_1.getObjectExpressionProperty)(multerOptions, LIMITS_OPTION)) === null || _a === void 0 ? void 0 : _a.value;
    if (limitsPropertyValue && limitsPropertyValue.type === 'ObjectExpression') {
        const fileSizeProperty = (0, utils_1.getObjectExpressionProperty)(limitsPropertyValue, FILE_SIZE_OPTION);
...
function checkBodyParser(context, callExpression) {
    ...
    const limitsProperty = (0, utils_1.getObjectExpressionProperty)(options, LIMITS_OPTION);
...
function getSizeValue(context, node) {
    const literal = (0, utils_1.getValueOfExpression)(context, node, 'Literal');
    if (literal) {
