    ...
    create(context) {
        ...
        function checkAccessor(accessor) {
            ...
            if (matchingFields.length > 0 &&
                ...
                context.report({
                    message: (0, utils_1.toEncodedMessage)(primaryMessage, secondaryLocations, secondaryMessages),
        ...
        return {
            ...
            ClassBody: (node) => {
                ...
                const fields = getFieldMap(classBody.body, classElement => (classElement.type === 'ClassProperty' ||
