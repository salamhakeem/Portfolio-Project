    ...
    create(context) {
        ...
        return {
            CallExpression: (node) => {
                ...
                const symbol = (0, utils_1.getSymbolAtLocation)(callee, services);
                if (!!symbol) {
                    return;
                }
                if ((0, utils_1.isIdentifier)(callee, OPEN_DATABASE)) {
                    context.report({ node: callee, message: MESSAGE });
                }
                if (callee.type !== 'MemberExpression' || !(0, utils_1.isIdentifier)(callee.property, OPEN_DATABASE)) {
                    return;
                }
                const typeName = (0, utils_1.getTypeAsString)(callee.object, services);
