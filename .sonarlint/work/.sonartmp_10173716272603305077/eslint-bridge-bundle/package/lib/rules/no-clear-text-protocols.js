...
exports.rule = {
    create(context) {
        function checkNodemailer(callExpression) {
            ...
            const secure = (0, utils_1.getObjectExpressionProperty)(firstArgValue, 'secure');
            const requireTls = (0, utils_1.getObjectExpressionProperty)(firstArgValue, 'requireTLS');
            const port = (0, utils_1.getObjectExpressionProperty)(firstArgValue, 'port');
        ...
        function checkCallToFtp(callExpression) {
            ...
            if (callExpression.callee.type === 'MemberExpression' &&
                ...
                const newExpression = (0, utils_1.getValueOfExpression)(context, callExpression.callee.object, 'NewExpression');
                if (!!newExpression &&
                    ((_a = (0, utils_1.getModuleNameOfNode)(context, newExpression.callee)) === null || _a === void 0 ? void 0 : _a.value) === 'ftp') {
                    const firstArg = callExpression.arguments.length > 0 ? callExpression.arguments[0] : null;
                    if (!firstArg) {
                        return;
                    }
        ...
        function isExceptionUrl(value) {
            if (INSECURE_PROTOCOLS.includes(value)) {
                const parent = (0, utils_1.getParent)(context);
        ...
        return {
            ...
            CallExpression: (node) => {
                ...
                if ((0, utils_1.isCallToFQN)(context, callExpression, 'nodemailer', 'createTransport')) {
