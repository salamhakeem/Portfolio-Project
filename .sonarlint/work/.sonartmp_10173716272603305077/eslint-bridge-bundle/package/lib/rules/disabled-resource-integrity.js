    ...
    create(context) {
        ...
        return {
            'VariableDeclarator[init.type="CallExpression"]': (node) => {
                ...
                const typeName = (0, utils_1.getTypeAsString)(left, services);
                if (!(0, utils_1.isIdentifier)(callee.object, 'document') ||
                    !(0, utils_1.isIdentifier)(callee.property, 'createElement') ||
