    ...
    create(context) {
        return {
            CallExpression(node) {
                ...
                // serveStatic(...)
                const module = (0, utils_1.getModuleNameOfIdentifier)(context, callee);
                if ((module === null || module === void 0 ? void 0 : module.value) === SERVE_STATIC && args.length > 1) {
                    let options = args[1];
                    if (options.type === 'Identifier') {
                        options = (0, utils_1.getUniqueWriteUsage)(context, options.name);
                    }
                    const dotfilesProperty = (0, utils_1.getObjectExpressionProperty)(options, 'dotfiles');
