...
exports.parseExceptionCodeOf = exports.ParseExceptionCode = exports.unloadTypeScriptEslint = exports.getFileContent = exports.buildParsingOptions = exports.buildSourceCode = void 0;
/*
...
function buildParsingOptions(input, usingBabel = false, parserOption, sourceType = 'module') {
    ...
    const programs = 'programId' in input ? [(0, programManager_1.getProgramById)(input.programId)] : undefined;
    const options = {
        tokens: true,
        comment: true,
        loc: true,
