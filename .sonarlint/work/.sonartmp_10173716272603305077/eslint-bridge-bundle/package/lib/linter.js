...
const object_shorthand_decorator_1 = require("./rules/object-shorthand-decorator");
...
class LinterWrapper {
    ...
    constructor(inputRules, customRules = [], environments = [], globals = []) {
        ...
        this.linter.defineRule(ACCESSOR_PAIRS, (0, accessor_pairs_decorator_1.decorateAccessorPairs)(this.linter.getRules().get(ACCESSOR_PAIRS)));
        ...
        this.linter.defineRule(PREFER_TEMPLATE, (0, prefer_template_decorator_1.decoratePreferTemplate)(this.linter.getRules().get(PREFER_TEMPLATE)));
        // core implementation of this rule raises issues on type exports
        const NO_REDECLARE = 'no-redeclare';
        this.linter.defineRule(NO_REDECLARE, (0, no_redeclare_decorator_1.decorateNoRedeclare)(this.linter.getRules().get(NO_REDECLARE)));
        // core implementation of this rule raises issues on aura lightning components
        const OBJECT_SHORTHAND = 'object-shorthand';
        this.linter.defineRule(OBJECT_SHORTHAND, (0, object_shorthand_decorator_1.decorateObjectShorthand)(this.linter.getRules().get(OBJECT_SHORTHAND)));
